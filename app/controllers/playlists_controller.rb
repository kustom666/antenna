class PlaylistsController < ApplicationController
  ...
  def generate_preview
    ...
    File.open("/home/deployer/genpreview#{user.nickname}-#{playlist.title}.sh",'w+') { |f| f.write("ffmpeg -f concat -i /home/deployer/videolist#{user.nickname} -c copy -f flv '#{Rails.public_path}/#{user.nickname}-#{playlist.title}-preview.flv'")}
